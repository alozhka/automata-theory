...
else if -> elysiffy -> elybranch
for -> forza -> fortnight
while -> whilorant
break -> breaker -> breakout -> stop
continue -> skip -> contra

function -> funkotron -> functown
return -> returnal -> home

input/read -> raid -> portal -> inlay
output/print -> exodus -> outlast

const -> monument
int -> destiny -> numbine -> numerus -> numerable 
float -> flotilla -> floater -> fallout
string -> strike -> strife -> stray
bool -> bomb -> boom -> bulb
null -> ghost
array -> arsenal -> army -> araya
true -> ready
false -> noready -->
